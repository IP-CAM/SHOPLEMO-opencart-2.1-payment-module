...
class ControllerPaymentShoplemo extends Controller
{
    public function index()
    {
        ...
        //return $this->load->view('payment/shoplemo.tpl', $data);
        return $this->load->view($this->config->get('config_template') . '/template/payment/shoplemo.tpl', $data);
    }
    ...
    public function get_payment_page_url()
    {
        ...
        $requestBody = [
            ...
            //'callback_url' => 'http://eu.ngrok.io/opencart_21/index.php?route=payment/shoplemo/callback',
